...
public class GridPaneDemo extends Application {   
	...
	public void init() {
         // 加载MySQL数据库驱动程序
         String dburl="jdbc:mysql://localhost:3306/webstore?user=root&password=123456&useSSL=false"; 
	     try{
    ...
    public void start(Stage stage) {
        ...
        HBox hbox = new HBox();
        hbox.setSpacing(10); 
        hbox.getChildren().addAll(first,prior,next,
last,insert,delete,update);
